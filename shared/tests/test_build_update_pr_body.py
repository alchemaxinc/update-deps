...
class TestBuildUpdatePrBody(unittest.TestCase):
    ...
    def test_build_body_renders_sections(self):
        ...
        self.assertIn(":robot: *This PR was automatically generated by a bot.*", body)
        self.assertIn(
            "[Get this update action for your own repository.](https://github.com/alchemaxinc/update-deps/tree/main/cargo)",
            body,
        )
